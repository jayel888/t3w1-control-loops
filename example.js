...
someMessage = "Mango";
// evaluate if the first part is true, if it is, we return the second one
...
// if both false, it will return the second value
circuitLogicMessage = "" || "We have a message ||";
